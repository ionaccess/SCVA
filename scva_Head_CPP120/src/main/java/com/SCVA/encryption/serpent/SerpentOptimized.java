package com.SCVA.encryption.serpent;
...
public class SerpentOptimized implements BlockCipher {
    ...
    public void encrypt(byte[] text) {
		...
		//Utils.println(Hex.toString(data));
		byte[] temp = new byte[] {
        ...
        for(int i = 0; i < 32; i++){
           ...
           // Utils.println("key:"+Hex.toString(roundKey));
            for(int n = 0; n < 16; n++){
  ...
  /*
    public static void main( String[] args ) {
        ...
        if(args.length == 1)
        {
            ...
            Utils.println(Hex.toString(test_in));
            ...
            //File decryption in CBC mode
                ...
                Utils.println("Encrypt/Decrypt option invalid, input e or d as 5th argument.");
            }
            out_stream.close();
            }
            catch(IOException e){
