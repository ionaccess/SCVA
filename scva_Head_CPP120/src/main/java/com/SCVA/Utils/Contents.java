...
public final class Contents
{
	...
	public static final class Type
	{
		 ...
		 * but string must include "http://" or "https://".
		 */
		 ...
		 * intent.putExtra(Intents.Encode.TYPE, CONTACT); Bundle bundle = new Bundle();
		 ...
		 * CA 94102"); intent.putExtra(Intents.Encode.DATA, bundle);
		 */
