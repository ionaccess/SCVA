...
include $(CLEAR_VARS)
LOCAL_MODULE    := SCVA_Modem_Interface
LOCAL_CPP_EXTENSION := .cxx .cpp .cc
LOCAL_SRC_FILES := SCVA_Fldigi_Interface.cpp v2_fec/Transport.cpp v2_fec/AndroidBridge.cpp fldigi/modem.cxx \
...
LOCAL_C_INCLUDES := $(LOCAL_PATH) $(LOCAL_PATH)/fldigi/include
LOCAL_LDLIBS  := -llog
include $(BUILD_SHARED_LIBRARY)


include $(CLEAR_VARS)
LOCAL_MODULE    := SCVA_Flmsg_Interface
LOCAL_CPP_EXTENSION := .cxx .cpp .cc
LOCAL_SRC_FILES := 	SCVA_Flmsg_Interface.cpp flmsg/flmsg.cxx \
