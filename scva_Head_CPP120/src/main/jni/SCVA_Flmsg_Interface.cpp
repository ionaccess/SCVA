...
#include "SCVA_Flmsg_Interface.h"
#include <jni.h>
...
extern string getPreferenceS2(string preferenceString, string defaultValue) {
	...
	//Find the Java class
	jclass cls = gEnv2->FindClass("com/SCVA/config");
...
Java_com_SCVA_Message_saveEnv( JNIEnv* env, jclass thishere)
{
	gEnv2 = env;
	gJobject2 = thishere;
}
...
Java_com_SCVA_Message_ProcessWrapBuffer( JNIEnv* env,
...
Java_com_SCVA_Message_getUnwrapText( JNIEnv* env,
		jclass thishere)
{
...
//Get the text contained within the wrap sequence ("the unwrapped text")
extern "C" JNIEXPORT jstring
Java_com_SCVA_Message_getUnwrapFilename( JNIEnv* env,
		jclass thishere)
{
...
//Get the text contained within the wrap sequence ("the unwrapped text")
extern "C" JNIEXPORT jstring
Java_com_SCVA_Message_geterrtext( JNIEnv* env,
		jclass thishere)
{
...
extern "C" JNIEXPORT jstring
Java_com_SCVA_Message_customHtmlDisplayFormat( JNIEnv* env,
...
extern "C" JNIEXPORT jstring
Java_com_SCVA_Message_customHtmlEditingFormat( JNIEnv* env,
...
//Processes HTML form and custom content, returns formatted Html display string
extern "C" JNIEXPORT
jstring Java_com_SCVA_Message_customHtmlEditFormat( JNIEnv* env,
		jclass thishere, jstring myHtmlForm, jstring myCustomField)
{
	//Convert to C++ type
	const char *cHtmlForm = NULL;
...
extern "C" JNIEXPORT
jstring Java_com_SCVA_Message_createCustomBuffer( JNIEnv* env,
...
extern "C" JNIEXPORT
jstring Java_com_SCVA_Message_createHardCodedHeader( JNIEnv* env,
...
extern "C" JNIEXPORT
jstring Java_com_SCVA_Message_updateHeader( JNIEnv* env,
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_namedFile( JNIEnv* env,
		jclass thishere)
{
...
//Creates the flmsg data file name based on options/preferences
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_compressMaybe(JNIEnv* env,
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_estimate(JNIEnv* env,
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_dateStamp(JNIEnv* env,
		jclass thishere) {
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_timeStamp(JNIEnv* env,
		jclass thishere) {
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_dateTimeStamp(JNIEnv* env,
		jclass thishere) {
...
Java_com_SCVA_Message_getArlMsgTextList(JNIEnv* env,
		jclass thishere)
{
...
extern "C" JNIEXPORT jobjectArray
Java_com_SCVA_Message_getArlHxTextList(JNIEnv* env,
		jclass thishere)
{
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_cbrgcheck(JNIEnv* env,
...
extern "C" JNIEXPORT jstring
Java_com_SCVA_Message_gettxtrgmsg( JNIEnv* env,
		jclass thishere)
{
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_escape(JNIEnv* env,
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_unescape(JNIEnv* env,
		jclass thishere, jstring myString) {
...
extern "C" JNIEXPORT jstring Java_com_SCVA_Message_expandarl(JNIEnv* env,
